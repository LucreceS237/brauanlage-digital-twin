...
class SafetySystem:
    ...
    def evaluate(self, snapshot: ProcessSnapshot) -> list[Diagnostic]:
        ...
        temp_map = (
            ("k3_temperature_c", snapshot.k3_temperature_c, FaultCode.EMERGENCY_003_K3_TEMP_TOO_LOW, FaultCode.EMERGENCY_004_K3_TEMP_TOO_HIGH),
            ("k1_temperature_c", snapshot.k1_temperature_c, FaultCode.EMERGENCY_005_K1_TEMP_TOO_LOW, FaultCode.EMERGENCY_006_K1_TEMP_TOO_HIGH),
            ("k2_temperature_c", snapshot.k2_temperature_c, FaultCode.EMERGENCY_007_K2_TEMP_TOO_LOW, FaultCode.EMERGENCY_008_K2_TEMP_TOO_HIGH),
        ...
        level_map = (
            ("k3_level_l", snapshot.k3_level_l, FaultCode.EMERGENCY_011_K3_LEVEL_NEGATIVE, FaultCode.EMERGENCY_012_K3_LEVEL_TOO_HIGH),
            ("k1_level_l", snapshot.k1_level_l, FaultCode.EMERGENCY_013_K1_LEVEL_NEGATIVE, FaultCode.EMERGENCY_014_K1_LEVEL_TOO_HIGH),
            ("k2_level_l", snapshot.k2_level_l, FaultCode.EMERGENCY_015_K2_LEVEL_NEGATIVE, FaultCode.EMERGENCY_016_K2_LEVEL_TOO_HIGH),
