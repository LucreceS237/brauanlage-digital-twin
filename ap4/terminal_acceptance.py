...
def build_acceptance_steps() -> list[ScenarioStep]:
    ...
    return [
        ScenarioStep(
            "T01",
            "Starttaste setzt IDLE -> PRECHECK",
            base.with_updates(start_requested=True),
            1,
            BrewState.PRECHECK,
            "PRECHECK",
        ),
        ...
        ScenarioStep(
            "T03",
            "Nachguss ausreichend -> MASHING",
            base.with_updates(
                v3_open=True,
                flow_k1_to_k2_l_min=1.0,
                k2_level_l=4.0,
            ),
            3,
            BrewState.MASHING,
        ...
        ScenarioStep(
            "T04",
            "Maischen abgeschlossen -> LAUTERING",
            base.with_updates(
                k2_level_l=4.0,
                k2_temperature_c=66.0,
                v4_open=True,
                flow_k2_to_k3_l_min=1.0,
            ),
            3,
            BrewState.LAUTERING,
            "LAUTERING",
        ...
        ScenarioStep(
            "T06",
            "Kochen abgeschlossen -> COOLING",
            base.with_updates(
                k3_level_l=4.0,
                k3_temperature_c=100.0,
            ),
            3,
            BrewState.COOLING,
            "COOLING",
        ...
        ScenarioStep(
            "T07",
            "Kühlziel mit V5/Pumpe -> TRANSFER_TO_K4",
            base.with_updates(
                k3_temperature_c=24.0,
                v5_open=True,
                pump_on_feedback=True,
            ),
            1,
        ...
        ScenarioStep(
            "T08",
            "Austrag vollständig -> FERMENTING",
            base.with_updates(
                v5_open=True,
                pump_on_feedback=True,
                flow_k3_to_k4_l_min=1.0,
                k4_level_l=3.0,
            ),
            3,
        ...
        ScenarioStep(
            "T09",
            "Gärdauer erfüllt -> FINISHED",
            base.with_updates(
                k4_level_l=3.0,
                k4_temperature_c=18.0,
            ),
            3,
            BrewState.FINISHED,
            "FINISHED",
    ...
    tests = [
        (
            ...
            ProcessSnapshot(
                v3_open=True,
                flow_k1_to_k2_l_min=1.0,
                k1_temperature_c=50.0,
            ),
            FaultCode.ERROR_001_K1_NACHGUSS_TEMP_LOW.value,
        ),
        (
            "F02",
            BrewState.NACHGUSS,
            ...
            FaultCode.ERROR_003_V3_CLOSED_IN_NACHGUSS.value,
        ),
        (
            "F03",
            BrewState.MASHING,
            ProcessSnapshot(
                k2_temperature_c=40.0,
                k2_level_l=4.0,
            ),
            FaultCode.ERROR_005_K2_MASHING_TEMP_LOW.value,
        ),
        (
            "F04",
            BrewState.BOILING,
            ProcessSnapshot(
                k3_temperature_c=110.0,
                k3_level_l=4.0,
            ),
            FaultCode.ERROR_011_K3_BOILING_TEMP_HIGH.value,
        ),
        (
            "F05",
            BrewState.TRANSFER_TO_K4,
            ProcessSnapshot(
                v5_open=True,
                pump_on_feedback=False,
                flow_k3_to_k4_l_min=1.0,
            ),
            FaultCode.ERROR_015_PUMP_OFF_TRANSFER_K4.value,
        ),
        (
            "F06",
            BrewState.FERMENTING,
            ProcessSnapshot(
                k4_temperature_c=30.0,
                k4_level_l=4.0,
            ),
            FaultCode.ERROR_018_K4_FERMENT_TEMP_HIGH.value,
        ),
        (
            "F07",
            BrewState.BOILING,
            ...
            FaultCode.EMERGENCY_001_ESTOP_ACTIVE.value,
        ),
        (
            "F08",
            BrewState.MASHING,
            ProcessSnapshot(
                k2_temperature_c=130.0,
                k2_level_l=4.0,
            ),
            FaultCode.EMERGENCY_006_K2_TEMP_TOO_HIGH.value,
        ),
    ]
