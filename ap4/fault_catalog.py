...
class FaultCode(Enum):
    ...
    ERROR_009_FLOW_K2_TO_K3_LOW = "ERROR_009_FLOW_K2_TO_K3_LOW"
    ERROR_010_K3_BOILING_TEMP_LOW = "ERROR_010_K3_BOILING_TEMP_LOW"
    ERROR_011_K3_BOILING_TEMP_HIGH = "ERROR_011_K3_BOILING_TEMP_HIGH"
    ERROR_012_K3_LEVEL_LOW_BOILING = "ERROR_012_K3_LEVEL_LOW_BOILING"
    ...
    ERROR_016_FLOW_K3_TO_K4_LOW = "ERROR_016_FLOW_K3_TO_K4_LOW"
...
FAULT_CATALOG: dict[FaultCode, FaultDescriptor] = {
    FaultCode.ERROR_001_K1_NACHGUSS_TEMP_LOW: _d(FaultCode.ERROR_001_K1_NACHGUSS_TEMP_LOW, "ERROR", "K1 Nachgusstemperatur zu niedrig", "K1/Nachguss", "NACHGUSS", "K1-Heizung, Sensor und Rezeptwert prüfen."),
    FaultCode.ERROR_002_K1_NACHGUSS_TEMP_HIGH: _d(FaultCode.ERROR_002_K1_NACHGUSS_TEMP_HIGH, "ERROR", "K1 Nachgusstemperatur zu hoch", "K1/Nachguss", "NACHGUSS", "K1-Heizung abschalten, Abkühlung abwarten, Sensor plausibilisieren."),
    ...
    FaultCode.ERROR_004_FLOW_K1_TO_K2_LOW: _d(FaultCode.ERROR_004_FLOW_K1_TO_K2_LOW, "ERROR", "Durchfluss K1 nach K2 zu niedrig", "Durchfluss K1->K2", "NACHGUSS", "V3, Leitung, DF-Sensor und Behälterfüllstand prüfen."),
    FaultCode.ERROR_005_K2_MASHING_TEMP_LOW: _d(FaultCode.ERROR_005_K2_MASHING_TEMP_LOW, "ERROR", "K2 Maischtemperatur zu niedrig", "K2/Maischen", "MASHING", "Kochfeld 1, Temperaturfühler und Rezeptfenster prüfen."),
    FaultCode.ERROR_006_K2_MASHING_TEMP_HIGH: _d(FaultCode.ERROR_006_K2_MASHING_TEMP_HIGH, "ERROR", "K2 Maischtemperatur zu hoch", "K2/Maischen", "MASHING", "Kochfeld 1 abschalten und Temperaturmessung validieren."),
    FaultCode.ERROR_007_K2_LEVEL_LOW_MASHING: _d(FaultCode.ERROR_007_K2_LEVEL_LOW_MASHING, "ERROR", "K2-Füllstand für Maischen zu niedrig", "K2/Füllstand", "MASHING", "Nachgussmenge und Füllstandssensor K2 prüfen."),
    ...
    FaultCode.ERROR_009_FLOW_K2_TO_K3_LOW: _d(FaultCode.ERROR_009_FLOW_K2_TO_K3_LOW, "ERROR", "Durchfluss K2 nach K3 zu niedrig", "Durchfluss K2->K3", "LAUTERING", "V4, Leitung und Durchflussmessung prüfen."),
    FaultCode.ERROR_010_K3_BOILING_TEMP_LOW: _d(FaultCode.ERROR_010_K3_BOILING_TEMP_LOW, "ERROR", "K3 Kochtemperatur zu niedrig", "K3/Kochen", "BOILING", "Kochfeld 2 und Temperaturfühler K3 prüfen."),
    FaultCode.ERROR_011_K3_BOILING_TEMP_HIGH: _d(FaultCode.ERROR_011_K3_BOILING_TEMP_HIGH, "ERROR", "K3 Kochtemperatur zu hoch", "K3/Kochen", "BOILING", "Kochfeld 2 abschalten und Temperatur validieren."),
    FaultCode.ERROR_012_K3_LEVEL_LOW_BOILING: _d(FaultCode.ERROR_012_K3_LEVEL_LOW_BOILING, "ERROR", "K3-Füllstand für Kochen zu niedrig", "K3/Füllstand", "BOILING", "Transfer K2->K3 und Sensor K3 prüfen."),
    ...
    FaultCode.ERROR_016_FLOW_K3_TO_K4_LOW: _d(FaultCode.ERROR_016_FLOW_K3_TO_K4_LOW, "ERROR", "Durchfluss K3 nach K4 zu niedrig", "Durchfluss K3->K4", "TRANSFER_TO_K4", "Pumpe, V5, Leitung und DF-Sensor prüfen."),
    ...
    FaultCode.EMERGENCY_003_K1_TEMP_TOO_LOW: _d(FaultCode.EMERGENCY_003_K1_TEMP_TOO_LOW, "EMERGENCY", "K1 Temperatur unter absoluter Grenze", "K1/Safety", "GLOBAL", "Sensorfehler oder unplausible Messung prüfen."),
    FaultCode.EMERGENCY_004_K1_TEMP_TOO_HIGH: _d(FaultCode.EMERGENCY_004_K1_TEMP_TOO_HIGH, "EMERGENCY", "K1 Temperatur über absoluter Grenze", "K1/Safety", "GLOBAL", "Heizung abschalten und Sicherheitsprüfung durchführen."),
    FaultCode.EMERGENCY_005_K2_TEMP_TOO_LOW: _d(FaultCode.EMERGENCY_005_K2_TEMP_TOO_LOW, "EMERGENCY", "K2 Temperatur unter absoluter Grenze", "K2/Safety", "GLOBAL", "Sensorfehler oder unplausible Messung prüfen."),
    FaultCode.EMERGENCY_006_K2_TEMP_TOO_HIGH: _d(FaultCode.EMERGENCY_006_K2_TEMP_TOO_HIGH, "EMERGENCY", "K2 Temperatur über absoluter Grenze", "K2/Safety", "GLOBAL", "Kochfeld 1 abschalten und Safety-Review durchführen."),
    FaultCode.EMERGENCY_007_K3_TEMP_TOO_LOW: _d(FaultCode.EMERGENCY_007_K3_TEMP_TOO_LOW, "EMERGENCY", "K3 Temperatur unter absoluter Grenze", "K3/Safety", "GLOBAL", "Sensorfehler oder unplausible Messung prüfen."),
    FaultCode.EMERGENCY_008_K3_TEMP_TOO_HIGH: _d(FaultCode.EMERGENCY_008_K3_TEMP_TOO_HIGH, "EMERGENCY", "K3 Temperatur über absoluter Grenze", "K3/Safety", "GLOBAL", "Kochfeld 2 abschalten und Safety-Review durchführen."),
    ...
    FaultCode.EMERGENCY_011_K1_LEVEL_NEGATIVE: _d(FaultCode.EMERGENCY_011_K1_LEVEL_NEGATIVE, "EMERGENCY", "K1 Füllstand negativ", "K1/Safety", "GLOBAL", "Füllstandsmessung K1 prüfen."),
    FaultCode.EMERGENCY_012_K1_LEVEL_TOO_HIGH: _d(FaultCode.EMERGENCY_012_K1_LEVEL_TOO_HIGH, "EMERGENCY", "K1 Füllstand über Schutzgrenze", "K1/Safety", "GLOBAL", "Überfüllung und Sensor K1 prüfen."),
    FaultCode.EMERGENCY_013_K2_LEVEL_NEGATIVE: _d(FaultCode.EMERGENCY_013_K2_LEVEL_NEGATIVE, "EMERGENCY", "K2 Füllstand negativ", "K2/Safety", "GLOBAL", "Füllstandsmessung K2 prüfen."),
    FaultCode.EMERGENCY_014_K2_LEVEL_TOO_HIGH: _d(FaultCode.EMERGENCY_014_K2_LEVEL_TOO_HIGH, "EMERGENCY", "K2 Füllstand über Schutzgrenze", "K2/Safety", "GLOBAL", "Überfüllung und Sensor K2 prüfen."),
    FaultCode.EMERGENCY_015_K3_LEVEL_NEGATIVE: _d(FaultCode.EMERGENCY_015_K3_LEVEL_NEGATIVE, "EMERGENCY", "K3 Füllstand negativ", "K3/Safety", "GLOBAL", "Füllstandsmessung K3 prüfen."),
    FaultCode.EMERGENCY_016_K3_LEVEL_TOO_HIGH: _d(FaultCode.EMERGENCY_016_K3_LEVEL_TOO_HIGH, "EMERGENCY", "K3 Füllstand über Schutzgrenze", "K3/Safety", "GLOBAL", "Überfüllung und Sensor K3 prüfen."),
