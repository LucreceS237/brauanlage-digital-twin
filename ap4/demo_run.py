...
def run_demo() -> None:
    ...
    steps = [
        ...
        ("Nachguss", base.with_updates(v3_open=True, flow_k1_to_k2_l_min=1.1, k2_level_l=4.0), 3),
        ("Maischen", base.with_updates(k2_level_l=4.0, k2_temperature_c=66.0, v4_open=True, flow_k2_to_k3_l_min=1.0), 3),
        ("Läutern", base.with_updates(v4_open=True, flow_k2_to_k3_l_min=1.0, k3_level_l=4.0), 3),
        ("Kochen", base.with_updates(k3_level_l=4.0, k3_temperature_c=100.0), 3),
        ("Kühlen", base.with_updates(k3_temperature_c=24.0, v5_open=True, pump_on_feedback=True), 1),
        ("Austrag", base.with_updates(v5_open=True, pump_on_feedback=True, flow_k3_to_k4_l_min=1.0, k4_level_l=3.0), 3),
        ("Gären", base.with_updates(k4_level_l=3.0, k4_temperature_c=18.0), 3),
    ]
    print("AP4 Demo Version 4 - Normalpfad K1 -> K2 -> K3 -> K4")
    print("=" * 80)
